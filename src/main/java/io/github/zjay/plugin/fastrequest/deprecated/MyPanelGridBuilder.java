...
public class MyPanelGridBuilder implements PanelBuilder {
     ...
     */
    public MyPanelGridBuilder add(@NotNull PanelBuilder builder) {
     ...
     * @return <code>this</code>
     */
    public MyPanelGridBuilder resize() {
        this.expand = true;
        return this;
    }
     ...
     * @return <code>this</code>
     */
    public MyPanelGridBuilder splitColumns() {
