package io.github.zjay.plugin.fastrequest.util.tree;

import io.github.zjay.plugin.fastrequest.util.Builder;
import io.github.zjay.plugin.fastrequest.util.tree.parser.NodeParser;
...
//		Assers.isFalse(isBuild, "Current tree has been built.");
	...
	private void buildFromMap() {
		...
		final Map<E, Tree<E>> eTreeMap = io.github.zjay.plugin.fastrequest.util.MapUtils.sortByValue(this.idTreeMap, false);
