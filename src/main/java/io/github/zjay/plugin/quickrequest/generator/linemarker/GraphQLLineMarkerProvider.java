...
import io.github.zjay.plugin.quickrequest.generator.impl.GraphQLMethodGenerator;
...
//            log.debug("handleMessageEntity error", e);
    ...
    private static Object analyzeReference(Object type) {
        ...
        String packageName = "";
        if (resolve != null){
            packageName = GraphQLLineMarkerProvider.getPackageName((PsiElement) resolve);
