package io.github.zjay.plugin.quickrequest.jfree;
...
public class MyStandardChartTheme implements ChartTheme, Cloneable,
    ...
    public static ChartTheme createJFreeTheme() {
        return new MyStandardChartTheme("JFree");
    }
    ...
    public static ChartTheme createDarknessTheme() {
        MyStandardChartTheme theme = new MyStandardChartTheme("Darkness");
        theme.titlePaint = JBColor.BLACK;
        theme.subtitlePaint = JBColor.BLACK;
        theme.legendBackgroundPaint = UIUtil.getTextFieldBackground();
        theme.legendItemPaint = JBColor.BLACK;
        theme.chartBackgroundPaint = UIUtil.getTextFieldBackground();
        theme.plotBackgroundPaint = UIUtil.getTextFieldBackground();
        theme.plotOutlinePaint = JBColor.BLACK;
        theme.baselinePaint = JBColor.BLACK;
        theme.crosshairPaint = JBColor.RED;
        theme.labelLinkPaint = JBColor.BLACK;
        theme.tickLabelPaint = JBColor.BLACK;
        theme.axisLabelPaint = JBColor.BLACK;
        theme.shadowPaint = JBColor.BLACK;
        theme.itemLabelPaint = JBColor.BLACK;
        ...
        theme.errorIndicatorPaint = JBColor.LIGHT_GRAY;
     ...
     */
    public MyStandardChartTheme(String name) {
        this(name, false);
    }
     ...
     *                included.
     */
    public MyStandardChartTheme(String name, boolean shadow) {
        ...
        this.titlePaint = JBColor.BLACK;
        this.subtitlePaint = JBColor.BLACK;
        this.legendBackgroundPaint = UIUtil.getTextFieldBackground();
        this.legendItemPaint = JBColor.BLACK;
        this.chartBackgroundPaint = UIUtil.getTextFieldBackground();
        this.drawingSupplier = new DefaultDrawingSupplier();
        this.plotBackgroundPaint = UIUtil.getTextFieldBackground();
        this.plotOutlinePaint = JBColor.BLACK;
        this.labelLinkPaint = JBColor.BLACK;
        this.labelLinkStyle = PieLabelLinkStyle.CUBIC_CURVE;
        this.axisOffset = new RectangleInsets(4, 4, 4, 4);
        this.domainGridlinePaint = JBColor.BLACK;
        this.rangeGridlinePaint = JBColor.BLACK;
        this.baselinePaint = JBColor.BLACK;
        this.crosshairPaint = JBColor.BLUE;
        this.axisLabelPaint = JBColor.BLACK;
        this.tickLabelPaint = JBColor.BLACK;
        this.barPainter = new GradientBarPainter();
        this.xyBarPainter = new GradientXYBarPainter();
        this.shadowVisible = false;
        this.shadowPaint = JBColor.BLACK;
        this.itemLabelPaint = JBColor.BLACK;
        this.thermometerPaint = JBColor.BLACK;
        this.errorIndicatorPaint = JBColor.BLACK;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MyStandardChartTheme)) {
            return false;
        }
        MyStandardChartTheme that = (MyStandardChartTheme) obj;
