...
import io.github.zjay.plugin.quickrequest.util.MapUtils;
import io.github.zjay.plugin.quickrequest.util.tree.parser.DefaultNodeParser;
...
public class TreeUtil {
	...
	public static <E> Tree<E> buildSingle(Map<E, Tree<E>> map, E rootId) {
		final Tree<E> tree = MapUtils.getFirstNoneNull(map.values().iterator());
		if (null != tree) {
