package io.github.zjay.plugin.quickrequest.util.tree;

import io.github.zjay.plugin.quickrequest.util.Builder;
import io.github.zjay.plugin.quickrequest.util.tree.parser.NodeParser;
...
//		Assers.isFalse(isBuild, "Current tree has been built.");
	...
	private void buildFromMap() {
		...
		final Map<E, Tree<E>> eTreeMap = io.github.zjay.plugin.quickrequest.util.MapUtils.sortByValue(this.idTreeMap, false);
		List<Tree<E>> rootTreeList = new ArrayList<>();
		E parentId;
